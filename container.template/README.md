...
1- copier le contenue de ce dossier ./container.template dans le dossier cible
...
3- ajouter ce dontainer au docker-compose
...
sera accessible deouis un navigateur a l url
