...
export class ProfileView extends BaseComponent<ProfileState> {
  constructor() {
...
`;
    ...
    this.innerHTML = `
          <img
                ...
                <p class=${`text-lg font-medium mt-2 ${user.role === "admin" ? "text-red-500" : "text-blue-500"}`}>
                    Role: ${user.role}
                </p>
