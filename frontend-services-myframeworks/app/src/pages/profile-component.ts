    ...
    this.innerHTML = `
      <section class=" px-4 py-8 bg-gray-100 dark:bg-gray-900 text-gray-900 dark:text-white">
        <div class="max-w-3xl mx-auto">
          <h1 class="text-3xl font-bold mb-6 text-center">${this.t("PROFILE.TITLE")}</h1>
          ...
          <div class="bg-white dark:bg-gray-800 rounded-2xl shadow p-6 space-y-6">
            ...
            <a href="/profile/edit" class="flex justify-end">
              <button class="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-lg transition">                ${this.t("PROFILE.MODIFY")}
</button>
            </a>
          </div>
        </div>
