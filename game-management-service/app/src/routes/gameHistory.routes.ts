...
async function gameHistoryRoutes(app: FastifyInstance) {
...
/*   app.addHook('onRequest', async (request, reply) => {
  ...
  app.get("/", {/* preHandler: [loggerMiddleware], *//* schema: UserSchema.getGameHistorys */}, gameHistoryController.getGameHistorys);
  app.get("/:id",/*  {schema: UserSchema.getGameHistoryById} ,*/ gameHistoryController.getGameHistoryById);
  app.put("/:id"/* , {schema: UserSchema.updateUser} */, gameHistoryController.updateGameHistory);
  app.delete("/:id",/*  {schema: UserSchema.deleteGameHistory}, */ gameHistoryController.deleteGameHistory);
 // app.post("/query", {schema: UserSchema.requestQuery}, GameHistoryController.requestQuery);
  //pour tester les users
  app.post("/"/* , {schema: UserSchema.createGameHistory } */, gameHistoryController.createGameHistory);
